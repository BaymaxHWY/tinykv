...
stale log entries:
	...
	to its log, and then calls 'AppendEntry' method to send those entries to
	...
	'MessageType_MsgAppend' contains log entries to replicate. A leader calls AppendEntry,
	...
	it's more than majority (quorum), it becomes leader and calls 'AppendEntry'.
	...
	'AppendEntry' method, which then calls 'sendAppend' method to each
